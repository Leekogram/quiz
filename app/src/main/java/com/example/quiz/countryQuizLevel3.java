...
public class countryQuizLevel3 extends AppCompatActivity {
    ...
    String quizData3[][] = {
            ...
            {"nigeria","2013","1994","1980","None"},
            {"ghana","1982","1978","1965","2000"},
            {"algeria","2019","2017","1990","1957"},
            {"egypt","2010","2008","2006","2004"},
            {"cameroon","2017","2006","2015","2019"},
            {"tunisia","2004","2005","1998","2006"},
            {"south_africa","1996","1999","2003","2001"},
            {"togo","None","1992","1994","1984"},
            {"cotedivoire","2015","1992","2017","1994"},
            {"senegal","None","All","1970","2012"}
    };

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_country_quiz_level3);
        ...
        try {
            ...
            if (bundleVal.equals("countryquizlevel3")) {
    ...
    public void showResult() {
        ...
        if (rightAnswerCount >= 10) {
            ...
            timer.cancel();
            Intent i = new Intent(countryQuizLevel3.this, countryQuizFinalActivity.class);
            i.putExtra("score", rightAnswerCount);
            i.putExtra("level",bundleVal);
            startActivity(i);

        } else {
            if (!countryQuizLevel3.this.isFinishing()) {
                ...
                builder.setNegativeButton("Save & Exit", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (!c.moveToFirst()) {
                            ...
                            db.execSQL(query);
                            Toast.makeText(countryQuizLevel3.this, "You have got a high score", Toast.LENGTH_LONG).show();
                        } else {
                            c.moveToLast();
                        ...
                        mEditor.commit();
                        Intent i = new Intent(countryQuizLevel3.this, countryQuizLevel.class);
                        startActivity(i);
                        finish();
                    }
                });
