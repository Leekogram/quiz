...
public class ClubQuizLevel3 extends AppCompatActivity {
    ...
    String quizData3[][] = {
            ...
            //{"questionimage","Right Answer","option1","option2","option3"}
            {"arsenal","Unai Emery","Jurgen Klopp","Asene Wenger","Diego Simeone"},
            {"athletico_madrid","Diego Simeone","Frank Lampard","Maurizio Sarri","Pep Guardiola"},
            {"barcelona","Ernesto Valverde","Ole Gunnar Solskjaer","Thomas Tuchel","Unai Emery"},
            {"chelsea","Frank Lampard","Diego Simeone","Jurgen Klopp","Maurizio Sarri"},
            {"mancity","Pep Guardiola","Zinedine Zidane","Frank Lampard","Ole Gunnar Solskjaer"},
            {"man_utd","Ole Gunnar Solskjaer","Sir Alex Ferguson","Unai Emery","Zinedine Zidane"},
            {"juventus","Maurizio Sarri","Ernesto Valverde","Thomas Tuchel","Jurgen Klopp"},
            {"psg","Thomas Tuchel","Pep Guardiola","Diego Simeone","Moussa Diaby"},
            {"liverpool","Jurgen Klopp","Alberto Moreno","Maurizio Sarri","Asene Wenger"},
            {"madrid","Zinedine Zidane","Sir Alex Ferguson","Mourinho","Pep Guardiola"}
    };

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_club_quiz_level3);
        ...
        try {
            ...
            if (bundleVal.equals("clubquizlevel3")) {
    ...
    public void showResult() {
        ...
        if (rightAnswerCount >= 10) {
            ...
            timer.cancel();
            Intent i = new Intent(ClubQuizLevel3.this, ClubQuizFinalActivity.class);
            ...
            if (!ClubQuizLevel3.this.isFinishing()) {
                ...
                builder.setNegativeButton("Save & Exit", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (!c.moveToFirst()) {
                            ...
                            db.execSQL(query);
                            Toast.makeText(ClubQuizLevel3.this, "You have got a high score", Toast.LENGTH_LONG).show();
                        } else {
                            c.moveToLast();
                        ...
                        mEditor.commit();
                        Intent i = new Intent(ClubQuizLevel3.this, ClubQuizLevels.class);
                        startActivity(i);
                        finish();
                    }
                });
